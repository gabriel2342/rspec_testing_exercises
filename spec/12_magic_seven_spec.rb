...
describe MagicSeven do
  ...
  describe '#subtract_random_number' do
    context "when the previous step is 12 and the random number is 8" do
  ...
  describe '#play' do
    context 'when the random number is 23' do
      subject(:game_five) {described_class.new(23)}
    ...
    context 'when the random number is ...' do
      # remove the 'x' before running this test
      subject(:game_six) {described_class.new(42)}
    ...
    context 'when the random number is ...' do
      subject(:game_seven) {described_class.new(137)}     
 
      it 'will return 7' do
        expect(game_seven.play).to eq(7)
      end
    end
  end
end
